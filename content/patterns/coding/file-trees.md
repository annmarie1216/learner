...
Representing folder/file structures is simple and accessible in **Learner**. Which is just as well, because some components may need to conform to a certain folder structure.
